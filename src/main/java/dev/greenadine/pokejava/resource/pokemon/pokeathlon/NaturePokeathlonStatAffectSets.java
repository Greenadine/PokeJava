 ...
 * @see PokeathlonStat
 */
public record NaturePokeathlonStatAffectSets(@JsonProperty("increase") @NotNull List<NaturePokeathlonStatEffect> increase,
                                             @JsonProperty("decrease") @NotNull List<NaturePokeathlonStatEffect> decrease) {
}
