 ...
 */
@ResourcePath("move-target")
public final class MoveTarget extends NamedApiResource implements NameLocalized, DescriptionLocalized {
    ...
    @JsonCreator
    private MoveTarget(@JsonProperty("id") int id,
