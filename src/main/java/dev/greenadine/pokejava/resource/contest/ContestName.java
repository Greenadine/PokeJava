 ...
 *
 * @param name     the name for the contest.
 * @param color    the color associated with the contest's name.
 * @param language the language this name is in.
 * @see ContestType
 */
public record ContestName(@JsonProperty("name") @Nullable String name,
                          @JsonProperty("color") @NotNull String color,
